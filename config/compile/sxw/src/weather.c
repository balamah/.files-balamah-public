...
main(int argc, char** argv)
{
    ...
    snprintf(big_font_buf, 64, "JetBrainsMonoNL NFM:size=%d:style=Bold", textsize);
    char small_font_buf[64];
    snprintf(small_font_buf, 64, "JetBrainsMonoNL NFM:size=%d", (int)(textsize * 0.4285));
    char huge_font_buf[64];
    snprintf(huge_font_buf, 64, "JetBrainsMonoNL NFM:size=%d:style=Bold", (int)(textsize * 1.8571));
