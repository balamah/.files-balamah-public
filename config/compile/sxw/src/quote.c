...
static void redraw()
{
    ...
    char quote[1024];
	sh("~/.config/scripts/get/random-bible-verse | fold -s -w 37 | tr '\\n' '$' ", quote, 1024);
...
main(int argc, char** argv)
{
    ...
    snprintf(big_font_buf, 64, "JetBrainsMonoNL NFM:size=%d:style=Italic", textsize);
    char small_font_buf[64];
    snprintf(small_font_buf, 64, "JetBrainsMonoNL NFM:size=%d", (int)(textsize * 0.7647));
