...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("JetBrains Mono NFM"
                               :size 13.0
                               :weight normal
                               :width normal)
